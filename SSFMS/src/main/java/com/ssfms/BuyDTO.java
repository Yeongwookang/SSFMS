...
public class BuyDTO {
	...
	public void setBan_Finish(String ban_Finish) {
		this.ban_Finish = ban_Finish;
	}
	...
	public String getShop_Reg() {
		return shop_Reg;
	}
	public void setShop_Reg(String shop_Reg) {
		this.shop_Reg = shop_Reg;
	}
