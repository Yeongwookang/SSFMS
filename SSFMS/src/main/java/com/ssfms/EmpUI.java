...
public class EmpUI {
	...
	protected void update() {
		...
		try {
			...
			if (result == 0) {
				System.out.println("사원 수정에 실패했습니다.");
			} else {
				System.out.println("사원 수정에 성공했습니다.");
			}
	...
	protected void cupdate() {
		...
		try {
			...
			int result = dao.updateCare(dto);

			if (result == 0) {
				System.out.println("경력사항 수정에 실패했습니다.");
			} else {
				System.out.println("경력사항 수정에 성공했습니다.");
			}
	...
	protected void ainsert() {
		...
		try {
			...
			System.out.println("[ 등록된 연봉코드 : " + adto.getAsalNo() + " ]");
		} catch (Exception e) {
	...
	protected void aupdate() {
		...
		try {
			...
			int result = dao.updateAsal(adto);

			if (result == 0) {
				System.out.println("연봉 수정에 실패했습니다.");
			} else {
				System.out.println("연봉 수정에 성공했습니다.");
			}
		} catch (Exception e) {
	...
	protected void sinsert() {
		...
		try {
			...
			System.out.println("등록된 급여전표코드 : " + accdto.getStateNo());
		} catch (Exception e) {
			e.printStackTrace();
	...
	protected void sdelete() {
		...
		try {
			...
			if (result == 0) {
				...
				System.out.println("급여 등록이 취소되었습니다.");
			}
	...
	public void menu6() {
		...
		while (true) {
			try {
				do {
					System.out.println("-----------------------------------------------------------------");
					System.out.println("[1]전표등록 [2]전표취소 [3]전표리스트 [4]돌아가기  ");
					System.out.println("-----------------------------------------------------------------");
					System.out.print(" => ");
					ch = Integer.parseInt(br.readLine());
				} while (ch < 1 || ch > 4);
